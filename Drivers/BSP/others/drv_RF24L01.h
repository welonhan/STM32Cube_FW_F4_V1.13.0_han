...
#define RF24L01_SET_CS_HIGH( )		HAL_GPIO_WritePin(RF24L01_CS_GPIO_PORT, RF24L01_CS_GPIO_PIN, GPIO_PIN_SET)
#define RF24L01_SET_CS_LOW( )			HAL_GPIO_WritePin(RF24L01_CS_GPIO_PORT, RF24L01_CS_GPIO_PIN, GPIO_PIN_RESET)

#define RF24L01_GET_IRQ_STATUS( )		(( RF24L01_IRQ_GPIO_PORT->IDR & (uint32_t)RF24L01_IRQ_GPIO_PIN) != RF24L01_IRQ_GPIO_PIN ) ? 0 : 1	//IRQ状态

#define drv_spi_read_write_byte	SPIx_WriteRead
...
#define W_ACK_PLOAD			0xA8	//PIPE0 ACK in PRX mode
