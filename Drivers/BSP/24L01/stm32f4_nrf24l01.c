...
void TM_NRF24L01_InitPins(void) {
  ...
  /* nrf24l01 EN----PB0 GPIO pin configuration  */  
  ...
  /*##-2- Configure peripheral GPIO ##########################################*/  
  /* nrf24l01 SPE CE----PB0 GPIO pin configuration  */ 
...
void BSP_NRF24L01_Test(void)
{
	...
	TM_NRF24L01_SetTxAddress(paddr);
	
	TM_NRF24L01_ReadRegisterMulti(NRF24L01_REG_TX_ADDR, temp, 5);
	for(i=0;i<5;i++)
	{
		if(addr[i]!=temp[i])
		{
