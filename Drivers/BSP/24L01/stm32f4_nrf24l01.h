...
GND			GND			Ground
VCC			3.3V		3.3V
CE			PB0			RF activated pin
CSN			PA15			Chip select pin for SPI
...
/* Pins configuration */
#define NRF24L01_CE_LOW				HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_RESET)
#define NRF24L01_CE_HIGH			HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_SET)
#define NRF24L01_CSN_LOW			HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, GPIO_PIN_RESET)
#define NRF24L01_CSN_HIGH			HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, GPIO_PIN_SET)
